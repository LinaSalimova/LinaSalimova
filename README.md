...
<table width="100%" border='0'>
 ...
 <tr> <td valign="middle">:heavy_check_mark: Graduation project which includes UI + API + Mobile Autotests for <a target="_blank" href="https://ru.wikipedia.org/" > wikipedia.org </a></br> Project: <a target="_blank" href="https://github.com/LinaAlekseeva/wikipedia">diplom-wikipedia </a></td><td valign="middle"></code></td></tr>
