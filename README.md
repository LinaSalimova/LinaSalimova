...
<table width="100%" border='0'>
   <tr> 
    ...
    <tr> <td valign="middle">:heavy_check_mark: Mobile Autotests for <a target="_blank" href="https://ru.wikipedia.org/" > tinkoff.ru </a> mobile application</br> Project: <a target="_blank" href="https://github.com/LinaAlekseeva/wikipedia">diplom-mobile-wikipedia </a></td><td valign="middle">- Степовой подход для описания Allure Step</br>- Различные файлы конфигураций для запуска тестов:</br> <code>  - на сервисе Browserstack с помощью Jenkins</code></br><code>  - на локально развернутом эмуляторе Android Studio</code></td></tr>
